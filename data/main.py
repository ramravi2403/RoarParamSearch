...
def print_config(args):
    ...
    print(f"Keep ApprovalFY:  {args.keep_approvalfy}")
    if not args.keep_approvalfy and args.split_strategy == "chronological":
        print("                  (Used for sorting only, dropped from features)")
